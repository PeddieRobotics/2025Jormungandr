...
public class RobotContainer {
    ...
    private LimelightBackTop llBackTop;
    private LimelightBackBottom llBackBottom;
    ...
    public RobotContainer() {
        ...
        llBackTop = LimelightBackTop.getInstance();
        llBackBottom = LimelightBackBottom.getInstance();
